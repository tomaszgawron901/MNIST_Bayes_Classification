import src.MNIST_Data_Loader as Loader
from src.Naive_Bayes_Classification import NaiveBayesClassification
from src.Non_Naive_Bayes_Classification import NonNaiveBayesClassification
